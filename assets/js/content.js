...
window.WEDDING = {
  ...
  event: {
    ...
    startISO: '2027-03-20T08:00:00+07:00',
    ...
    calendarDetails:
     'พิธีเช้า 08:00–11:00 น.\n' +
     'พิธีเจริญพระพุทธมนต์ · ตักบาตรและถวายภัตตาหารแด่พระสงฆ์ · พิธีหมั้น · พิธีหลั่งน้ำพระพุทธมนต์ (ฤกษ์มงคล 09:39 น.)\n' +
  ...
  schedule: {
    ...
    // เพิ่ม/ลบบรรทัดได้ตามต้องการ แค่เพิ่ม–ลบ { ... } ในลิสต์นี้ จะกี่บรรทัดก็ได้
    //   time      = เวลา          unit  = หน่วย (เว้นว่างได้)
  ...
  info: {
    ...
    parking: {
      ...
      note: 'พิธีเริ่มเวลา 08:00 น. ขอความกรุณามาถึงก่อนเวลาประมาณ 20 นาที'
    }
  },
  ...
  rsvp: {
    ...
    slots: [
      { value: 'morning-monk',  title: 'ร่วมพิธีทำบุญตักบาตร (08:00 น.)', note: 'Joining Morning Monk Ceremony' },
  ...
  footer: {
    ...
    // ★ ภาพปิดท้าย: เจ้าบ่าวเจ้าสาวกับแมวสองตัว  false = ไม่แสดง
    scene:    true,
    sceneAlt: 'ภาพเจ้าบ่าวเจ้าสาวจับมือกัน มีแมวสองตัวเคล้าอยู่ข้าง ๆ'
  },
